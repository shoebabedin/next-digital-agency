...
const Accordion = () => {
  ...
  useEffect(() => {
    fetch("/Data/accordion.json")
      .then((res) => res.json())
      .then((differnet) => setAccordion(differnet));
  }, []);
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12">
              ...
              <div className="accordion">
                <div className="grid grid-cols-12 gap-4">
                  {accordion.length > 0 && accordion.map((item, index) => (
                    <div
                      id={item.id}
                      key={index}
                    ...
                    >
                      ...
                      <li
                        className={`answer font-normal text-base leading-6 text-[rgba(57,62,80,0.4)] ${
                          accordionOpen === item.id && "!list-item"
                        }`}
                      >
                        {item.ans}
                      </li>
